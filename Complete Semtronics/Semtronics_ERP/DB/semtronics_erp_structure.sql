...
--
-- Host: localhost
-- Generation Time: May 08, 2014 at 11:34 AM
...
CREATE TABLE `oppurtunities_comments` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `oppurtunities_comments`
--
...
CREATE TABLE `oppurtunity_status` (
  `id` int(11) NOT NULL auto_increment,
...
CREATE TABLE `rawmaterialassignment` (
  `id` bigint(20) NOT NULL auto_increment,
  `vendorid` bigint(20) NOT NULL,
...
CREATE TABLE `saleorder_comments` (
  `id` bigint(20) NOT NULL auto_increment,
...
--
-- Dumping data for table `saleorder_comments`
--
...
CREATE TABLE `salesorder_status` (
  `id` int(11) NOT NULL auto_increment,
...
--
-- Dumping data for table `sales_order_approval`
--
