<?php
	...
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM user WHERE name='".$_POST['name']."' && password='".$_POST['confirmpassword']."' && id!='".$_SESSION['id']."'");
	}
	...
	function User_Update()
	{
		if($_POST['confirmpassword'])
			return mysqli_query($_SESSION['connection'],"UPDATE user SET phone='".$_POST['phone']."', password='".$_POST['confirmpassword']."' WHERE id='".$_SESSION['id']."'");
		else
			return mysqli_query($_SESSION['connection'],"UPDATE user SET phone='".$_POST['phone']."' WHERE id='".$_SESSION['id']."'");
	}
?>