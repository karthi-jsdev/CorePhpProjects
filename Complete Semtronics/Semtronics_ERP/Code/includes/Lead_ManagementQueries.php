<?php
	...
	{
		return mysql_query("SELECT COUNT(*) as total FROM leads WHERE id like '%".$Search."' or id like '".$Search."%' or id like '%".$Search."%' or name like '%".$Search."' or name like '".$Search."%' or name like '%".$Search."%' ORDER BY id DESC");
	}
	function Lead_Select_ByLimit($Start, $Limit)
	{
		return mysql_query("SELECT * FROM leads ORDER BY id DESC LIMIT $Start, $Limit");
	}
	function Lead_Select_ByLimitSearch($Start, $Limit, $Search)
	{
		return mysql_query("SELECT * FROM leads WHERE id like '%".$Search."' or id like '".$Search."%' or id like '%".$Search."%' or name like '%".$Search."' or name like '".$Search."%' or name like '%".$Search."%' ORDER BY id DESC LIMIT $Start, $Limit");
	}
	function Vendor_Category_Name($Id)
	{
		return mysql_query("SELECT * FROM vendorcategory WHERE id='".$Id."'");
	}
	...
	{
		return mysql_query("INSERT INTO leadscomments(id,leadid,commentsdate,comments,followupdate,updatedby) values('','".$_POST['leadid']."','".date('Y-m-d H:i:s')."','".$_POST['comments']."','".date('Y-m-d',strtotime($_POST[followupdate]))."','".$_SESSION['id']."')");
	}
	function Leadcomments_Select_Count_All()
	{
		return mysql_query("SELECT COUNT(*) as total FROM leadscomments WHERE leadid='".$_GET['leadid']."' ORDER BY id DESC");
	}
	function Leadcomments_Select_ByLimit($Start, $Limit)
	{
		return mysql_query("SELECT * FROM leadscomments WHERE leadid='".$_GET['leadid']."' ORDER BY id DESC LIMIT $Start, $Limit");
	}
	function UpdatedBy_Name($Id)
	{
		return mysql_query("SELECT * FROM user WHERE id='".$Id."'");
	}
	
	//Lead Followup Count
	function Lead_followupSelect_Count_All()
	{
		return mysql_query("SELECT * FROM leadscomments
	...
	{
		return mysql_query("SELECT count(*) as total FROM leadscomments
		JOIN leads ON leadscomments.leadid = leads.id
	...
	{
		return mysql_query("SELECT COUNT(*) as total FROM leads WHERE add_to_account='1' ORDER BY id DESC");
	}
	function Lead_AddtoaccountSelect_Count_All_By_Search($Search)
	{
		return mysql_query("SELECT COUNT(*) as total FROM leads WHERE add_to_account='1' AND (id like '%".$Search."' or id like '".$Search."%' or id like '%".$Search."%' or name like '%".$Search."' or name like '".$Search."%' or name like '%".$Search."%') ORDER BY id DESC");
	}
	function Lead_AddtoaccountSelect_ByLimit($Start, $Limit)
	{
		return mysql_query("SELECT * FROM leads WHERE add_to_account='1' ORDER BY id DESC LIMIT $Start, $Limit");
	}
	function Lead_AddtoaccountSelect_ByLimitSearch($Start, $Limit, $Search)
	{
		return mysql_query("SELECT * FROM leads WHERE add_to_account='1' AND (id like '%".$Search."' or id like '".$Search."%' or id like '%".$Search."%' or name like '%".$Search."' or name like '".$Search."%' or name like '%".$Search."%' ) ORDER BY id DESC LIMIT $Start, $Limit");
	}
