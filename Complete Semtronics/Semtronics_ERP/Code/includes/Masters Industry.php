<section role="main" id="main">
	<?php
		...
		{
			Industry_Delete_ById($_GET['id']);
			$message = "<br /><div class='message success'><b>Message</b> : Industry deleted successfully</div>";
		}
		...
		if(isset($_POST['Submit']) || isset($_POST['Update']))
		{
				...
				if(isset($_POST['Submit']))
				{
					...
					{
						Industry_Insert();
						$message = "<br /><div class='message success'><b>Message</b> : Industry added successfully</div>";
					}
				}
				else if(isset($_POST['Update']))
				{
					...
					{
						Industry_Update();
						$message = "<br /><div class='message success'><b>Message</b> : Industry details updated successfully</div>";
					}
				}
			foreach($Columns as $Col)
				$_POST[$Col] = "";
	...
	<div class="columns" style='width:902px;'>
		...
		<form method="post" action="?page=<?php echo $_GET['page']."&subpage=".$_GET['subpage']."&innersubpage=".$_GET['innersubpage']."&pageno=".$_GET['pageno']; ?>" id="form" class="form panel" onsubmit="return validation()">
			...
			<header><h2>Add Industry</h2></header>
			<hr />				
			<fieldset>
				<div class="clearfix">
				...
				<tbody>
					...
					while($Industry = mysqli_fetch_assoc($IndustryRows))
					{
						echo "<tr style='valign:middle;'>
							...
							<td>".$Industry['name']."</td>
							<td ><a href='index.php?page=".$_GET['page']."&subpage=".$_GET['subpage']."&innersubpage=".$_GET['innersubpage']."&id=".$Industry['id']."&pageno=".$_GET['pageno']."&action=Edit' class='action-button' title='user-edit'><span class='user-edit'></span></a>  &nbsp; <a href='#' onclick='deleterow(".$Industry['id'].")' class='action-button' title='user-delete'><span class='user-delete'></span></a></td>
						</tr>";
					} ?>
				</tbody>
			</table>
