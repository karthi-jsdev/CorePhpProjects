...
<?php
	if(!$_GET['subpage'])
		$_GET['subpage'] = "spage->Stock_Management";
	...
	$SubHeaders = array("Stock_Management", "Issuance", "Product_Management", "Purchase_Planner","Internal_PO");
	foreach($SubHeaders as $SubHeader)
		echo str_replace($_GET['spage'].'" class="button button-gray', $_GET['spage'].'" class="button button-blue',
		'<a href="index.php?page=Stores&subpage=spage->'.$SubHeader.'" class="button button-gray">'.str_replace("_"," ", $SubHeader).'</a>&nbsp;');
	echo "<hr />";
