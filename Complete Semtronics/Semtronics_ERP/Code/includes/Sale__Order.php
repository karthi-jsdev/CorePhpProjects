<section role="main" id="main">
	...
	<script>
		$(function()
		{
			$("#6").datepicker({dateFormat: 'yy-mm-dd',minDate:0});
		});
	</script>
	<?php
	...
	<div class="columns" style='width:902px;'>
		<?php echo $message; ?>
		<form style="width:1000px" method="post" action="?page=<?php echo $_GET['page']; ?>&subpage=spage-><?php echo $_GET['spage']; ?>,ssubpage-><?php echo $_GET['ssubpage']; ?>" id="form" class="form panel" onsubmit="return validation()">
			...
			<fieldset>
				...
				<div class="clearfix">
					...
					<label>Shipping Address <font color="red">*</font>
						<textarea  id="shipping_address" maxlength="100" name="shipping_address" required="required" autocomplete="off"><?php echo $_POST['shipping_address']; ?></textarea>
					...
					<label>Billing Address <font color="red">*</font>
						<textarea  id="billing_address" maxlength="100" name="billing_address" required="required" autocomplete="off"><?php echo $_POST['billing_address']; ?></textarea>
					</label>
	...
	<?php	
		...
		while($Fetch_Sales_Order = mysqli_fetch_array($Select_Sales_Order))
		{
			...
			echo '<tr>
				...
				<td ><a href="index.php?page='.$_GET['page'].'&subpage=spage->'.$_GET['spage'].',ssubpage->'.$_GET['ssubpage'].'&id='.$Fetch_Sales_Order['id'].'&pageno='.$_GET['pageno'].'&action=Edit" class="action-button" title="user-edit"><span class="user-edit"></span></a>  &nbsp; <a href="#" onclick="deleterow('.$Fetch_Sales_Order['id'].')" class="action-button" title="user-delete"><span class="user-delete"></span></a></td>
			  </tr>';
		}
		echo '</table>';
...
<script>
	...
	function Search()
	{
		document.location.assign("index.php?page=<?php echo $_GET['page']; ?>&subpage=spage-><?php echo $_GET['spage']; ?>,ssubpage-><?php echo $_GET['ssubpage']; ?>&pageno=<?php echo $_GET['pageno']; ?>&Search="+document.getElementById("Search").value);
	}
