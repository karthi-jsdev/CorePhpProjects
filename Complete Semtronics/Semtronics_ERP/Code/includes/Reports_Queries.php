<?php
	...
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM  vendorcategory order by id DESC");
	}
	function Vendors_Count()
	{
		return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total from vendor");
	}
	...
	function VendorsCategory_Count()
	{
		if($_GET['vendor_category_id'])
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total from vendor WHERE id='".$_GET['vendor_category_id']."'");
		else
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total from vendor");
	}
	...
	{
		if($_GET['vendor_category_id'])
			return mysqli_query($_SESSION['connection'],"SELECT * FROM vendor WHERE id='".$_GET['vendor_category_id']."' ORDER BY id DESC");
		else
			return mysqli_query($_SESSION['connection'],"SELECT * FROM vendor  ORDER BY id DESC");
	}
	//Invoice_Reports
	...
	{
		return mysqli_query($_SESSION['connection'],"SELECT distinct(vendor.name),vendor.id FROM invoice join vendor on invoice.vendorid=vendor.id order by vendor.id desc");
	}
	...
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM category order by id desc");
	}
	//Inspectiion Reports
	...
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM user ORDER BY id");
	}
	//Product Reports
	function product_category_name()
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM product_category order by id desc");
	}
	function product_subcategory_name($Id)
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM product_subcategory WHERE category_id = '".$Id."' ORDER BY id desc");
	}
	function Product_Select_Count_All()
	{
		if($_POST['productcode'])
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM product JOIN products on products.id=product.productcode WHERE product.productcode='".$_POST['productcode']."'ORDER BY product.id DESC");
		else
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM product JOIN products on products.id=product.productcode ORDER BY product.id DESC");
	}
	function Product_Select_Count_SubcategoryAll()
	{
		if($_POST['productcode'])
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM product product JOIN products on products.id=product.productcode ORDER BY product.id");		
	}
	function Product_Select_Count_Productcode()
	{
		if($_GET['productcode'])
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM product product JOIN products on products.id=product.productcode  WHERE product.productcode='".$_GET['productcode']."' ORDER BY product.id");		
	}
	function Product_Select_ByNoLimit()
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM product JOIN products on products.id=product.productcode ORDER BY product.id DESC");
	}
	function Product_Select_Subcategory_ByNoLimit()
	{
		if($_POST['productcode'])
			return mysqli_query($_SESSION['connection'],"SELECT * FROM product JOIN products on products.id=product.productcode WHERE product.productcode = '".$_POST['productcode']."'  ORDER BY product.id DESC");
	}
	function Product_Select_Subcategory_ByNoLimit_particulardata()
	{
		if($_GET['productcode'])
			return mysqli_query($_SESSION['connection'],"SELECT * FROM product JOIN products on products.id=product.productcode WHERE product.productcode = '".$_GET['productcode']."'  ORDER BY product.id DESC");
	}
	
	//Product BOM Queries
	function ProductBOM_Select_Count_All()
	{
		return mysqli_query($_SESSION['connection'],"Select COUNT(*) as total FROM productbom order by id desc");
	}
	function ProductBOM_Select_ByNOLimit()
	{
		return mysqli_query($_SESSION['connection'],"SELECT rawmaterial.materialcode,products.productcode,productbom.quantity,reference,tolerance,package,make,rawmaterial.partnumber FROM productbom JOIN products on products.id=productbom.productcode JOIN rawmaterial on rawmaterial.id=rawmaterialid ORDER BY productbom.id DESC");
	}
	...
	function ProductBOM_displaySelect_Count_All()
	{
		...
		else
		{
			...
			return  mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM productbom ".str_replace("=''","!=''",$Query)."");	
		}
	}
	function ProductBOM_displaySelect_ByNOLimit()
	{
		...
		else
		{
			...
			if(isset($_GET['productid']))
				$Query .= "productid='".$_GET['productid']."'";
			return  mysqli_query($_SESSION['connection'],"SELECT * FROM productbom ".str_replace("=''","!=''",$Query)."order by id desc");	
		}	
	}
	...
	{
		return mysqli_query($_SESSION['connection'],"SELECT * FROM leads ORDER BY id DESC");
	}
	...
	function Lead_Select_displayCount_All()
	{
		if($_GET['account'])
		{
			...
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM leads ".str_replace("=''","!=''",$Query)." AND leads.add_to_account='1' ");
		}
		else
		{
			$Query = "WHERE ";
			...
			if(isset($_GET['industry_category_id']))
				$Query .= "leads.industry_category_id='".$_GET['industry_category_id']."'";
			return mysqli_query($_SESSION['connection'],"SELECT COUNT(*) as total FROM leads ".str_replace("=''","!=''",$Query)." ");
		}	
	}
	function Lead_Select_BydisplayNoLimit()
	{
		if($_GET['account'])
		{
			...
			if(isset($_GET['industry_category_id']))
				$Query .= "leads.industry_category_id='".$_GET['industry_category_id']."'";
			return mysqli_query($_SESSION['connection'],"SELECT * FROM leads JOIN clientcategory ON leads.client_category_id = clientcategory.id JOIN reference ON reference.id = leads.reference_id JOIN reference_group ON reference_group.id = leads.reference_group_id JOIN industry_category ON industry_category.id = leads.industry_category_id ".str_replace("=''","!=''",$Query)." AND leads.add_to_account='1' ORDER by leads.id desc");
		}
		else
		{
			$Query = "WHERE ";
	...
	{
			return mysqli_query($_SESSION['connection'],"select count(*) as total from saleorder_comments where status_id='".$_GET['status']."' order by id desc");
	}
	function Select_CommentsNolimitdiplay()
	{
			return mysqli_query($_SESSION['connection'],"select * from saleorder_comments where status_id='".$_GET['status']."' order by id desc");
	}
