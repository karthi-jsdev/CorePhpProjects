<section role="main" id="main">
	<?php
		...
		if($_GET['action'] == 'Edit')
		{
			$Class = mysqli_fetch_assoc(Title_Select_ById());
		...
		if(isset($_POST['Submit']) || isset($_POST['Update']))
		{
			...
			else if(isset($_POST['Update']))
			{
				...
				if(mysqli_num_rows(Title_Select_ByNamePWDId()))
					$message = "<br /><div class='message error'><b>Message</b> : This Title already exists</div>";
				else
				{
					Title_Update();
	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			<h3>Title List
				<?php
				$TitleTotalRows = mysqli_fetch_assoc(Title_Select_Count_All());
			...
			<table class="paginate sortable full">
				...
				<tbody>
					...
					while($Title = mysqli_fetch_assoc($ClassRows))
					{
