<?php
	...
	function Resource_Update($Stime,$Etime)
	{
		if($_FILES['photo']['tmp_name'])
		{
			...
			$image = addslashes(file_get_contents($_FILES['photo']['tmp_name']));
			if($_POST['todate']=='Present')
				return mysql_query("update resource_update SET photo='".$image."',joiningdate='".date("Y-m-d",strtotime($_POST['fromdate']))."',leavingdate='".date("Y-m-d")."',name='".$_POST['name']."',groupid='".$_POST['groupid']."',departmentid='".$_POST['departmentid']."',designationid='".$_POST['designationid']."',qualification='".implode($_POST['qualificationid'],'$')."',specialization = '".$_POST['specializationid']."',status='".$_POST['status']."',days='".implode($_POST['days'],'$')."',starttime='".$Stime."',endtime='".$Etime."',titleid='".$_POST['titleid']."',kmc='".$_POST['kmc']."', mobile='".$_POST['mobile']."',mail1='".$_POST['mail1']."',mail2='".$_POST['mail2']."',dob='".date("Y-m-d",strtotime($_POST['dob']))."',sex='".$_POST['sex']."', reason ='".$_POST['reason']."', resign = '".$_POST['resign']."'  where id='".$_POST['id']."'");
			else if($_POST['todate'])
				return mysql_query("update resource_update SET photo='".$image."',joiningdate='".date("Y-m-d",strtotime($_POST['fromdate']))."',leavingdate='".date("Y-m-d",strtotime($_POST['todate']))."',name='".$_POST['name']."',groupid='".$_POST['groupid']."',departmentid='".$_POST['departmentid']."',designationid='".$_POST['designationid']."',qualification='".implode($_POST['qualificationid'],'$')."',specialization = '".$_POST['specializationid']."',status='".$_POST['status']."',days='".implode($_POST['days'],'$')."',starttime='".$Stime."',endtime='".$Etime."',titleid='".$_POST['titleid']."',kmc='".$_POST['kmc']."', mobile='".$_POST['mobile']."',mail1='".$_POST['mail1']."',mail2='".$_POST['mail2']."',dob='".date("Y-m-d",strtotime($_POST['dob']))."',sex='".$_POST['sex']."', reason ='".$_POST['reason']."', resign = '".$_POST['resign']."'  where id='".$_POST['id']."'");
			else
				return mysql_query("update resource_update SET photo='".$image."',joiningdate='".date("Y-m-d",strtotime($_POST['fromdate']))."',leavingdate='',name='".$_POST['name']."',groupid='".$_POST['groupid']."',departmentid='".$_POST['departmentid']."',designationid='".$_POST['designationid']."',qualification='".implode($_POST['qualificationid'],'$')."',specialization = '".$_POST['specializationid']."',status='".$_POST['status']."',days='".implode($_POST['days'],'$')."',starttime='".$Stime."',endtime='".$Etime."',titleid='".$_POST['titleid']."',kmc='".$_POST['kmc']."', mobile='".$_POST['mobile']."',mail1='".$_POST['mail1']."',mail2='".$_POST['mail2']."',dob='".date("Y-m-d",strtotime($_POST['dob']))."',sex='".$_POST['sex']."', reason ='".$_POST['reason']."', resign = '".$_POST['resign']."'  where id='".$_POST['id']."'");
		}
		else
		{
			if($_POST['todate']=='Present')
				return mysql_query("update resource_update SET joiningdate='".date("Y-m-d",strtotime($_POST['fromdate']))."',leavingdate='".date("Y-m-d")."',name='".$_POST['name']."',groupid='".$_POST['groupid']."',departmentid='".$_POST['departmentid']."',designationid='".$_POST['designationid']."',qualification='".implode($_POST['qualificationid'],'$')."',specialization = '".$_POST['specializationid']."',status='".$_POST['status']."',days='".implode($_POST['days'],'$')."',starttime='".$Stime."',endtime='".$Etime."',titleid='".$_POST['titleid']."',kmc='".$_POST['kmc']."', mobile='".$_POST['mobile']."',mail1='".$_POST['mail1']."',mail2='".$_POST['mail2']."',dob='".date("Y-m-d",strtotime($_POST['dob']))."',sex='".$_POST['sex']."', reason ='".$_POST['reason']."',resign = '".$_POST['resign']."'  where id='".$_POST['id']."'");
			else if($_POST['todate'])	
				return mysql_query("update resource_update SET joiningdate='".date("Y-m-d",strtotime($_POST['fromdate']))."',leavingdate='".date("Y-m-d",strtotime($_POST['todate']))."',name='".$_POST['name']."',groupid='".$_POST['groupid']."',departmentid='".$_POST['departmentid']."',designationid='".$_POST['designationid']."',qualification='".implode($_POST['qualificationid'],'$')."',specialization = '".$_POST['specializationid']."',status='".$_POST['status']."',days='".implode($_POST['days'],'$')."',starttime='".$Stime."',endtime='".$Etime."',titleid='".$_POST['titleid']."',kmc='".$_POST['kmc']."', mobile='".$_POST['mobile']."',mail1='".$_POST['mail1']."',mail2='".$_POST['mail2']."',dob='".date("Y-m-d",strtotime($_POST['dob']))."',sex='".$_POST['sex']."', reason ='".$_POST['reason']."',resign = '".$_POST['resign']."'  where id='".$_POST['id']."'");
			else	
				return mysql_query("update resource_update SET joiningdate='".date("Y-m-d",strtotime($_POST['fromdate']))."',leavingdate='',name='".$_POST['name']."',groupid='".$_POST['groupid']."',departmentid='".$_POST['departmentid']."',designationid='".$_POST['designationid']."',qualification='".implode($_POST['qualificationid'],'$')."',specialization = '".$_POST['specializationid']."',status='".$_POST['status']."',days='".implode($_POST['days'],'$')."',starttime='".$Stime."',endtime='".$Etime."',titleid='".$_POST['titleid']."',kmc='".$_POST['kmc']."', mobile='".$_POST['mobile']."',mail1='".$_POST['mail1']."',mail2='".$_POST['mail2']."',dob='".date("Y-m-d",strtotime($_POST['dob']))."',sex='".$_POST['sex']."', reason ='".$_POST['reason']."',resign = '".$_POST['resign']."'  where id='".$_POST['id']."'");
		}
	}
	function ResourceUpdate_Select_Count_All()
	{
		return mysql_query("Select count(*) as total from resource_update");
	}
	function ResourceUpdate_Select_Search_Count_All($Search)
	{
		return mysql_query("Select count(*) as total from resource_update WHERE name like '".$Search."%'  or  name like '%".$Search."'  or  name like '%".$Search."%'");
	}
	function ResourceUpdate_Select_ByLimit($Start, $Limit)
	{
		return mysql_query("Select title.name as titlename,resource_update.titleid,resource_update.photo as Photo,resource_update.joiningdate as Joining,resource_update.leavingdate as Leaving,
	...
	function Resource_Delete_ById($Id)
	{
		...
		return mysql_query("Delete From resource_update where id='".$Id."'");
	}
?>