<?php
	...
	{
		return mysql_query("Select * From blood_group order by name asc");
	}
	function Select_Nationality()
	{
		return mysql_query("Select * From nationality order by name asc");
	}
	function Select_Cast()
	{
		return mysql_query("Select * From community order by name asc");
	}
	function Select_Religion()
	{
		return mysql_query("Select * From religion order by name asc");
	}
	function Select_SubCast()
	{
		return mysql_query("Select * From subcast order by name asc");
	}
