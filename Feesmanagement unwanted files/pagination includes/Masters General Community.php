<section role="main" id="main">
	<?php
		...
		if($_GET['action'] == 'Edit')
		{
			$Class = mysql_fetch_assoc(Community_Select_ById());
		...
		if(isset($_POST['Submit']) || isset($_POST['Update']))
		{
			...
			else if(isset($_POST['Update']))
			{
				...
				if(mysql_num_rows(Community_Select_ByNamePWDId()))
	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			<h3>Community List
				<?php
				$CommunityTotalRows = mysql_fetch_assoc(Community_Select_Count_All());
			...
			<table class="paginate sortable full">
				...
				<tbody>
					...
					while($Community = mysql_fetch_assoc($CommunityRows))
					{
