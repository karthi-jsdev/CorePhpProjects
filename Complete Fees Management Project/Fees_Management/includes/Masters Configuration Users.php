		...
		<form method="post" action="?page=<?php echo $_GET['page']."&subpage=".$_GET['subpage']."&innersubpage=".$_GET['innersubpage']."&pageno=".$_GET['pageno']; ?>" id="form" class="form panel" onsubmit="return validation()">
			...
			<fieldset>
				...
				<div class="clearfix">
					...
					<input type="text" id="phone" name="phone" required="required" value="<?php echo $_POST['phone']; ?>" onkeypress="return isNumerics(event)"/>
				</div>
				<div class="clearfix">
...
<script>
	...
	function isNumerics(evt)
	{
		...
		if(charCode==8 || charCode == 9 || charCode == 45 || charCode == 46 || charCode == 35 || (charCode >= 37 && charCode <= 40))
			return true;
