<?php
 ...
 $c->yAxis->setWidth(2);
 # Add axis title 
 $c->yAxis->setTitle("RawMaterial Grade");
 ...
 $layer->addDataSet($data0, 0x66aaee, "Alloted RawMaterial Grade");
...
$chart8URL = $c->makeSession("chart8"); 
# Create an image map for the chart
$imageMap8 = $c->getHTMLImageMap("", "", "title='{xLabel}:  {value|0} Job'"); 
$c->makeChart("C:\\wamp\\www\\serviceprojects\\Chiramith_PPC_ERP\\includes\\Rawmaterialtypechart.png");
if(!$_GET['export']) 
{
 ?>
 <div style="width:970px;overflow-x:scroll;overflow-y:auto;">
	<img src="includes/getchart.php?<?php echo $chart8URL;?>" border="0" usemap="#map8">
</div>
 <map name="map8"> <?php echo $imageMap8;?> </map> 
<?php
} 
else
{ ?>
	<img src="C:/wamp/www/serviceprojects/Chiramith_PPC_ERP/includes/Rawmaterialtypechart.png" border="0" usemap="#map8">
