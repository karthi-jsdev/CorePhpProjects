<?php
 ...
 $c->yAxis->setWidth(2);
 # Add axis title 
 $c->yAxis->setTitle("Specification");
 ...
 $layer->addDataSet($data0, 0x66aaee, "Machine Specifications");
...
$imageMap7 = $c->getHTMLImageMap("", "", "title='{xLabel}:{value|0} Job '"); 
$c->makeChart("C:\\wamp\\www\\serviceprojects\\Chiramith_PPC_ERP\\includes\\MachineSpecification.png");
if(!$_GET['export']) 
{
 ?>
...
{ ?>
	<img src="C:/wamp/www/serviceprojects/Chiramith_PPC_ERP/includes/MachineSpecification.png" border="0" usemap="#map7">
