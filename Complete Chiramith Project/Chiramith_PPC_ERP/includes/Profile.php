			...
			<form method="post" action="?page=<?php echo $_GET['page']; ?>" id="form" class="form panel" onsubmit="return validation()">
				...
				<fieldset>
					...
					<div class="clearfix">
						...
						<input type="hidden" id="username" name="username" required="required" value="<?php echo $User['name']; ?>" onkeypress="return isAlphaOrNumeric(event)" />
						<?php echo $User['name']; ?>
					</div>
					<div class="clearfix">
					...
					<div class="clearfix">
						...
						<input type="text" id="phonenumber" name="phonenumber" required="required" value="<?php echo $User['phone']; ?>" onkeypress="return isNumeric(event)"/>
                    </div>
					<div class="clearfix">
				...
				<hr />
				<button class="button button-blue" type="submit" name="Update" value="Update">Update</button>&nbsp;&nbsp;
