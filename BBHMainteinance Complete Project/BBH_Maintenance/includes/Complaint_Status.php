...
{?>
	<form method="post" action="?page=<?php echo $_GET['page'];?>&subpage=<?php echo $_GET['subpage'];?>&TicketNo=<?php echo $_GET['TicketNo'];?>&ComplaintId=<?php echo $_GET['ComplaintId'];?>&pageno=<?php echo $_GET['pageno'];?>" id="form" class="form panel" enctype="multipart/form-data">
		<?php
		$_GET['Initial'] = 1;
