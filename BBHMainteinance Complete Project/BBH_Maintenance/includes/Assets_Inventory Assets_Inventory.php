	...
	<form method="POST" action="?page=<?php echo $_GET['page']."&subpage=".$_GET['subpage']."&pageno=".$_GET['pageno']; ?>" id="form" class="form panel" onsubmit="return validation()">
		...
		<fieldset>
			...
			<div class="clearfix">
				...
				<div id="equipmentname">
					<select id="equipment_idname" name="equipment_idname">
						...
						{
							if($Equipment['id'] == $_POST['equipment_id'])
			...
			<div class="clearfix">
				...
				<input type="text" name="serialnumber" id="serialnumber" value="<?php echo $_POST['serialnumber']; ?>" />
			</div>
			<div class="clearfix">
				<label>Equipment Id<font color="red">*</font></label>
				<input type="text" name="equipmentid" id="equipmentid" value="<?php echo $_POST['equipmentid']; ?>" />
			</div>
			<div class="clearfix">
			...
			<div class="clearfix">
				...
				<input type="text" name="unitcost" id="unitcost" value="<?php echo $_POST['unitcost']; ?>" />
			</div>
			<div class="clearfix">
			...
			<div class="clearfix">
				<label>Contact Person With No<font color="red">*</font></label>
				<input type="text" name="contactpersonno" id="contactpersonno" value="<?php echo $_POST['contactpersonno']; ?>" />
			</div>
			<div class="clearfix">
