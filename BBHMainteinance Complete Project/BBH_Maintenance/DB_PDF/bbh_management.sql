...
--
-- Host: localhost
-- Generation Time: Jul 07, 2014 at 06:21 AM
...
CREATE TABLE IF NOT EXISTS `complaint` (
  ...
  KEY `itemid` (`itemid`),
  KEY `locationid` (`locationid`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=3872 ;
...
CREATE TABLE IF NOT EXISTS `partdetails` (
  ...
  KEY `addedby` (`addedby`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=1958 ;
...
--
-- Constraints for table `assets_inventory`
--
ALTER TABLE `assets_inventory`
  ADD CONSTRAINT `assets_inventory_ibfk_1` FOREIGN KEY (`make_id`) REFERENCES `biomedical_make` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `assets_inventory_ibfk_2` FOREIGN KEY (`model_id`) REFERENCES `biomedical_model` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `assets_inventory_ibfk_3` FOREIGN KEY (`equipment_idname`) REFERENCES `biomedical_equipment` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `assets_inventory_ibfk_4` FOREIGN KEY (`department_id`) REFERENCES `department` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `complaint`
  ...
  ADD CONSTRAINT `complaint_ibfk_22` FOREIGN KEY (`subgroupid`) REFERENCES `subgroup` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
