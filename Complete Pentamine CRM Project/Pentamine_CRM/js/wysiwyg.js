...
// Include Style Sheet
document.write('<link rel="stylesheet" type="text/css" href="' +cssDir+ 'styles10.css">\n');
...
function generate_wysiwyg(textareaID) {
  ...
  + '</td></tr></table>\n';*/
var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:100%;Background-color:white; height:' + wysiwygHeight + 'px;border: 3px inset Black;"><tr><td valign="top">\n'
  + '<iframe frameborder="0" id="wysiwyg' + n + '"></iframe>\n'
  + '</td></tr></table>\n';
