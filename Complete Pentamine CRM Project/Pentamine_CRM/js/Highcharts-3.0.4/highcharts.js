...
function () {
    ...
    function mb(a, b, c, d) {
        var e, c = p(c, 1);
        e = a / c;
        b || (b = [1, 2, 5, 10], d && d.allowDecimals === !1 && (c === 1 ? b = [1, 2, 5, 10] : c <= 0.1 && (b = [1 / c])));
    ...
    function Cb(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (d = c[g], e = y[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + y[c[g + 1][0]]) / 2) break;
    ...
    var v, z = document,
        ...
        Nb = E.opera,
        qa = /msie/i.test(Da) && !Nb,
        eb = z.documentMode === 8,
        fb = /AppleWebKit/.test(Da),
        gb = /Firefox/.test(Da),
        Ob = /(Mobile|Android|Windows Phone)/.test(Da),
        wa = "http://www.w3.org/2000/svg",
        Y = !! z.createElementNS && !! z.createElementNS(wa, "svg").createSVGRect,
        Vb = gb && parseInt(Da.split("Firefox/")[1], 10) < 4,
        Z = !Y && !qa && !! z.createElement("canvas").getContext,
        Va, hb = z.documentElement.ontouchstart !== v,
        Pb = {}, yb = 0,
        cb, O, Xa, Ca, zb, y, xa = function () {}, Ea = [],
        Ba = "div",
        R = "none",
        Qb = "rgba(192,192,192," + (Y ? 1.0E-4 : 0.002) + ")",
        Db = "millisecond",
        nb = "second",
        Ya = "minute",
        Qa = "hour",
        ...
        sa = "year",
        Rb = "stroke-width",
        bb, ob, pb, rb, Sa, $a, ab, Fb, Gb, qb, Hb, Ib, $ = {};
            ...
            if (da(a)) c =
                ...
                for (c in a)
                    if (j = !1, d = a[c], e = k[c] && k[c].call(this, d, c), e !== !1) {
                        ...
                        else if (c === "title") e = g.getElementsByTagName("title")[0], e || (e = z.createElementNS(wa, "title"), g.appendChild(e)), e.textContent = d;
                        c === "strokeWidth" && (c = "stroke-width");
                        if (c === "stroke-width" || c === "stroke") {
                            this[c] = d;
                            if (this.stroke &&
                                this["stroke-width"]) w(g, "stroke", this.stroke), w(g, "stroke-width", this["stroke-width"]), this.hasStroke = !0;
                        ...
                        if (l && /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(c))
                            for (e = l.length; e--;) w(l[e], c, c === "height" ? u(d - (l[e].cutHeight || 0), 0) : d);
        ...
        htmlUpdateTransform: function () {
            if (this.added) {
                ...
                if (b.tagName === "SPAN") {
                    ...
                    var D = this.xCorr || 0,
                        F = this.yCorr || 0,
                        Tb = [j, g, b.innerHTML, this.textWidth].join(",");
                    if (Tb !== this.cTT) {
    ...
    Fa.prototype = {
        ...
        buildText: function (a) {
            ...
            n(e, function (e, f) {
                ...
                n(m, function (e) {
                    if (e !== "" || m.length === 1) {
                        var o = {}, n = z.createElementNS(wa, "tspan"),
                            t;
                        ...
                        if (e !== " " && (n.appendChild(z.createTextNode(e)), p ? o.dx = 0 : o.x = i, w(n, o), !p && f && (!Y && d && M(n, {
                            display: "block"
                        }), w(n, "dy", l || c.fontMetrics(/px$/.test(n.style.fontSize) ? n.style.fontSize : j.fontSize).h, fb && n.offsetHeight)), b.appendChild(n), p++, k))
                            for (var e = e.replace(/([^\^])-/g, "$1- ").split(" "), u, s = []; e.length || s.length;) delete a.bBox, u = a.getBBox().width, o = u > k, !o || e.length === 1 ? (e = s,
                                s = [], e.length && (n = z.createElementNS(wa, "tspan"), w(n, {
                                    dy: l || 16,
                                    x: i
                                }), t && w(n, "style", t), b.appendChild(n), u > k && (k = u))) : (n.removeChild(n.firstChild), s.unshift(e.pop())), e.length && n.appendChild(z.createTextNode(e.join(" ").replace(/- /g, "-")))
                    }
                })
            })
        },
                    ...
                    for (c in a)
                        if (d = a[c], m = !1, e = o[c] && o[c].call(this, d, c), e !== !1 && d !== null) {
                            ...
                            if (j && /^(x|y|r|start|end|width|height|innerR|anchorX|anchorY)/.test(c)) k ||
                                ...
                                m = [];
                                for (var p; e--;)
                                    if (pa(d[e])) m[e] = s(d[e] * 10) - 5;
                                    else if (d[e] === "Z") m[e] = "x";
                                else if (m[e] = d[e], d.isArc && (d[e] === "wa" || d[e] === "at")) p = d[e] === "wa" ? 1 : -1, m[e + 5] === m[e + 7] && (m[e + 7] -= p), m[e + 6] === m[e + 8] && (m[e + 8] -= p);
                                d = m.join(" ") || "x";
                                f.path = d;
                                if (l)
                            ...
                            else if (h === "shape" && c === "rotation") this[c] = f.style[c] = d, f.style.left = -s(ba(d * Ua) + 1) + "px", f.style.top = s(V(d * Ua)) + "px";
        ...
        var la = {
            ...
            color: function (a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = m.x1 || m[0] || 0, a = m.y1 || m[1] || 0, o = m.x2 || m[2] || 0, m = m.y2 || m[3] || 0, u = 'angle="' + (90 - N.atan((m - a) / (o - c)) * 180 / Ma) + '"', v();
                        else {
                            var j = m.r,
                                r = j * 2,
                                G = j * 2,
    ...
    La.prototype = {
        ...
        render: function (a, b, c) {
            var d = this.axis,
                ...
                r = !0,
                w = d.tickmarkOffset,
                G = this.getPosition(g, j, w, b),
                H = G.x,
                G = G.y,
                B = g && H === d.pos || !g && G === d.pos + d.len ? -1 : 1,
                x = d.staggerLines;
            this.isActive = !0;
            if (q) {
            ...
            if (m && F) t === "inside" && (F = -F), d.opposite && (F = -F), b = this.getMarkPath(H, G, F, m * B, g, f), o ? o.animate({
                d: b,
                opacity: c
    ...
    tb.prototype = {
        render: function () {
            ...
            } else return; if (t(F)) d.zIndex = F;
            if (o) q ? o.animate({
                d: q
            }, null, o.onGetPath) : (o.hide(), o.onGetPath = function () {
                o.show()
            });
            else if (q && q.length && (a.svgElem = o = r.path(q).attr(d).add(), s))
    ...
    Mb.prototype = {
        ...
        render: function (a) {
            var b = this.options,
                c = b.format,
                c = c ? Aa(c, this) : b.formatter.call(this);
    ...
    db.prototype = {
        ...
        defaultLabelFormatter: function () {
            ...
            if (h) g = Aa(h, this);
                ...
                for (; f-- && g === v;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = ya(b / c, -1) + e[f]);
        ...
        render: function () {
            var a = this,
                ...
                q = a.tickmarkOffset,
                p = d.lineWidth,
                D, F = b.hasRendered && t(a.oldMin) && !isNaN(a.oldMin);
            D = a.hasData;
            var u = a.showAxis,
                s, r;
            n([j, k, l], function (a) {
            ...
            if (D || f)
                if (a.minorTickInterval && !a.categories && n(a.getMinorTickPositions(), function (b) {
                    ...
                    if (c % 2 === 0 && b < a.max) l[b] || (l[b] = new tb(a)), s = b + q, r = g[c + 1] !== v ? g[c + 1] + q : a.max, l[b].options = {
                        from: e ? ea(s) : s,
                        to: e ? ea(r) : r,
                        color: o
            ...
            if (m) {
                ...
                for (d = m.length; d--;)
                    if (i = a.series, e = i[d ? "yAxis" : "xAxis"], m[d] && e)
                        if (h = d ? p(a.stackY, a.y) : a.x, e.isLog && (h = ma(h)), i.modifyValue && (h = i.modifyValue(h)),
    ...
    vb.prototype = {
        ...
        onContainerClick: function (a) {
            ...
            if (!b.cancelClick) c && this.inClass(a.target, "highcharts-tracker") ? (g = this.chartPosition, h = c.plotX, i = c.plotY, r(c, {
                ...
                "click", r(a, {
                    point: c
                })), b.hoverPoint && c.firePointEvent("click", a)) : (r(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - e) && C(b, "click", a))
        },
    ...
    wb.prototype = {
        ...
        renderItem: function (a) {
            ...
            if (!t && (a.legendGroup = d.g("legend-item").attr({
                zIndex: 1
            }).add(b.scrollGroup), r.drawLegendSymbol(b, a), a.legendItem = t = d.text(e.labelFormat ? Aa(e.labelFormat,
                a) : e.labelFormatter.call(a), m ? g + h : -h, b.baseline, A).css(x(a.visible ? i : j)).attr({
                align: m ? "left" : "right",
                zIndex: 2
    ...
    xb.prototype = {
        ...
        drawChartBox: function () {
            ...
            o = i + (a.shadow ? 8 : 0);
            if (i || j)
                if (e) e.animate(e.crisp(null, null, null, c -
                    o, d - o));
                else {
                    e = {
                        fill: j || R
    ...
    Q.prototype = {
        ...
        drawLegendSymbol: function (a) {
            ...
            var f = this.chart.renderer,
                g = this.legendGroup,
                a = a.baseline - s(f.fontMetrics(d.itemStyle.fontSize).b * 0.3);
            if (b.lineWidth) {
                d = {
        ...
        setData: function (a, b) {
            ...
            if (i && m > i) {
                ...
                if (pa(f)) {
                    ...
                    if (o)
                        for (i = 0; i < m; i++) d = a[i], j[i] = d[0], k[i] = d.slice(1, o + 1);
                    else
                ...
                for (i = 0; i < m; i++)
                    if (a[i] !== v && (d = {
                        series: this
                    }, this.pointClass.prototype.applyOptions.apply(d, [a[i]]), j[i] = d.x, k[i] = q ? this.toYData(d) : d.y, l[i] = d.z, h && d.name)) h[d.x] = d.name; da(k[0]) && ua(14, !0);
            this.data = [];
            this.options.data = a;
            this.xData = j;
            this.yData = k;
        ...
        setStackedPoints: function () {
            if (this.options.stacking && !(this.visible !== !0 && this.chart.options.chart.ignoreHiddenSeries !== !1)) {
                ...
                for (s = 0; s < c; s++) {
                    ...
                    if (p.total > l[n] && !m) l[n] = p.total;
                    else if (p.total < l[n] && m) l[n] =
                        p.total
                }
                i.oldStacks = {}
            }
        ...
        drawPoints: function () {
            ...
            if (l.enabled || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = S(g.plotX), e = g.plotY, k = g.graphic, i = g.marker || {}, a = l.enabled && i.enabled === v || i.enabled, m = c.isInsidePlot(s(d), e, c.inverted), a && e !== v && !isNaN(e) && g.y !== null)
        ...
        drawTracker: function () {
            ...
            if (j) j.attr({
                ...
                zIndex: 2
            }).addClass("highcharts-tracker").on("mouseover", o).on("mouseout",
                function (a) {
            ...
            if (this.options.stacking && !this.cropped) {
                ...
                n(c, function (a) {
                    g[a] ? b.push(g[a]) : (h = d.translate(a), k = f[a].percent ? f[a].total ? f[a].cum * 100 /
                        f[a].total : 0 : f[a].cum, i = e.toPixels(k, !0), b.push({
                            y: null,
                            plotX: h,
                            clientX: h,
                            plotY: i,
        ...
        drawGraph: function () {
            ...
            n(f, function (d) {
                ...
                f ? f.animate({
                    ...
                    fill: p(d[2],
                        oa(d[1]).setOpacity(p(c.fillOpacity, 0.75)).get()),
                    zIndex: 0
                }).add(a.group)
            })
        },
    ...
    K = ga(Q, {
        ...
        getColumnMetrics: function () {
            ...
            var c =
                I(P(c.transA) * (c.ordinalSlope || b.pointRange || c.closestPointRange || 1), c.len),
                j = c * b.groupPadding,
                k = (c - 2 * j) / i,
                l = b.pointWidth,
        ...
        drawDataLabels: function () {
            ...
            if (a.visible && (e.enabled || a._hasPointLabels)) {
                    ...
                    if (l > 0) {
                        ...
                        for (B = 0; B < K; B++) {
                            ...
                            if (E < B && b[B] !== null) E = B;
                                ...
                                for (w < K - B + E && b[B] !== null && (E = w - K + B); b[E] === null;) E++;
                            L.push({
                                i: E,
                                y: b[E]
                            });
                ...
                if (ta(C) === 0 || this.verifyDataLabelOverflow(C)) this.placeDataLabels(), t && g && n(this.points, function (b) {
                    i = b.connector;
                    v = b.labelPos;
                    if ((r = b.dataLabel) && r._pos) G = r._attr.visibility, z = r.connX, y = r.connY, j = k ? ["M", z + (v[6] === "left" ? 5 : -5), y, "C", z, y, 2 * v[2] - v[4], 2 * v[3] - v[5], v[2], v[3], "L", v[4], v[5]] : ["M", z + (v[6] === "left" ? 5 : -5), y, "L", v[2], v[3], "L", v[4], v[5]], i ? (i.animate({
                        d: j
