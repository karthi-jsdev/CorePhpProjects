...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<title><?php echo $_SESSION['SM_Client']; ?></title>
		...
		<div id="wrapper">
			...
			<section id="content">
			    <div class="wrapper">
					<?php
					//Main Section
					if($_SESSION['SM_id'] && $_GET['page'])
					{
						$filename = "includes/".$_GET['page'].".php";
						if((file_exists($filename) && in_array($_GET['page'], $headers)) || $_GET['page'] == "Profile")
							include($filename);
						else
							echo "Don't visit this website anonymously..!";
						/*/Sidebar
