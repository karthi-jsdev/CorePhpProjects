<section role="main" id="main">
	<?php
		...
		else if($_GET['action'] == 'Delete')
		{
			...
			$message = "<br /><div class='message success'><b>Message</b> : One Fees_Catagory name deleted successfully</div>";
		}
		...
		if(isset($_POST['Submit']) || isset($_POST['Update']))
		{
			...
			if(isset($_POST['Submit']))
			{
				if(mysql_num_rows($Fees_CatagoryResource))
					$message = "<br /><div class='message error'><b>Message</b> : This Fees_Catagory name already exists</div>";
				else
				{
					Fees_Catagory_Insert();
					$message = "<br /><div class='message success'><b>Message</b> : Fees_Catagory name added successfully</div>";
				}
			}
			else if(isset($_POST['Update']))
			{
				...
				else
				{
					...
					$message = "<br /><div class='message success'><b>Message</b> : Fees_Catagory details updated successfully</div>";
				}
			}
			foreach($Columns as $Col)
				$_POST[$Col] = "";
...
<div class="columns" style='width:902px;'>
	...
	<form method="post" action="?page=<?php echo $_GET['page']."&subpage=".$_GET['subpage']."&innersubpage=".$_GET['innersubpage']."&pageno=".$_GET['pageno']; ?>" id="form" class="form panel" onsubmit="return validation()">
		...
		<header><h2>Add Fees Catagory</h2></header>
		<hr />			
		<fieldset>
			<div class="clearfix">
				<label>Fees Catagory Name <font color="red">*</font></label>
...
<div class="columns">
	<h3>Fees Catagory List
		<?php
		$Fees_CatagoryTotalRows = mysql_fetch_assoc(Fees_Catagory_Select_Count_All());
		echo " : No. of Total Fees Catagory - ".$Fees_CatagoryTotalRows['total'];
		?>
	</h3>
	<hr />			
	<table class="paginate sortable full">
		<thead>
			<tr>
				...
				<th align="left">Fees Catagory Name</th>
