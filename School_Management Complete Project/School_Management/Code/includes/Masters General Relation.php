<section role="main" id="main">
	<?php
		...
		if($_GET['action'] == 'Edit')
		{
			$Class = mysql_fetch_assoc(Relation_Select_ById());
		...
		if(isset($_POST['Submit']) || isset($_POST['Update']))
		{
			...
			else if(isset($_POST['Update']))
			{
				...
				if(mysql_num_rows(Relation_Select_ByNamePWDId()))
	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			<h3>Relation List
				<?php
				$RelationTotalRows = mysql_fetch_assoc(Relation_Select_Count_All());
			...
			<table class="paginate sortable full">
				...
				<tbody>
					...
					while($Relation = mysql_fetch_assoc($RelationRows))
					{
