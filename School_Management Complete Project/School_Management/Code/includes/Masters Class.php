	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			<h3>Class List
				...
				echo " : No. of total Users - ".$ClassTotalRows['total'];
				?>
			</h3>
			<hr />			
			<table class="paginate sortable full">
				...
				<tbody>
					...
					if($_GET['pageno']>1)
						$i = $ClassTotalRows['total']- $Start;
					else
						$i = $ClassTotalRows['total'];
					...
					while($Class = mysql_fetch_assoc($ClassRows))
					{
						echo "<tr style='valign:middle;'>
							...
							<td>".$Class['name']."</td>
							<td ><a href='index.php?page=".$_GET['page']."&subpage=".$_GET['subpage']."&id=".$Class['id']."&pageno=".$_GET['pageno']."&action=Edit' class='action-button' title='user-edit'><span class='user-edit'></span></a>  &nbsp; <a href='#' onclick='deleterow(".$Class['id'].")' class='action-button' title='user-delete'><span class='user-delete'></span></a></td>
						</tr>";
					} ?>
				</tbody>
			</table>
