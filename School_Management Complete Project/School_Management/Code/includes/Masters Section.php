				...
				<tbody>
					...
					while($User = mysqli_fetch_assoc($UserRows))
					{
						...
						echo "<tr style='valign:middle;'>
							...
							<td>".$User['phone']."</td>
							<td>".$Role['role']."</td>
							<td ><a href='index.php?page=".$_GET['page']."&subpage=".$_GET['subpage']."&id=".$User['id']."&pageno=".$_GET['pageno']."&action=Edit' class='action-button' title='user-edit'><span class='user-edit'></span></a>  &nbsp; <a href='#' onclick='deleterow(".$User['id'].")' class='action-button' title='user-delete'><span class='user-delete'></span></a></td>
						</tr>";
					} ?>
				</tbody>
			</table>
