<section role="main" id="main">
	<?php
		...
		{
			Caste_Delete_ById($_GET['id']);
			$message = "<br /><div class='message success'><b>Message</b> : One Caste deleted successfully</div>";
		}
		...
		if(isset($_POST['Submit']) || isset($_POST['Update']))
		{
			...
			if(isset($_POST['Submit']))
			{
				...
				{
					Caste_Insert();
					$message = "<br /><div class='message success'><b>Message</b> : Caste added successfully</div>";
				}
			}
			else if(isset($_POST['Update']))
			{
				...
				{
					Caste_Update();
					$message = "<br /><div class='message success'><b>Message</b> : Caste Group details updated successfully</div>";
				}
			}
			foreach($Columns as $Col)
				$_POST[$Col] = "";
	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			...
			<table class="paginate sortable full">
				...
				<tbody>
					<?php
					if(!$CasteTotalRows['total'])
						echo '<tr><td colspan="7"><font color="red"><center>No data found</center></font></td></tr>';
					$Limit = 10;
					$total_pages = ceil($CasteTotalRows['total'] / $Limit);
					if(!$_GET['pageno'])
						$_GET['pageno'] = 1;
					...
					while($Caste = mysqli_fetch_assoc($CasteRows))
					{
						echo "<tr style='valign:middle;'>
							...
							<td>".$Caste['name']."</td>
							<td ><a href='index.php?page=".$_GET['page']."&subpage=".$_GET['subpage']."&innersubpage=".$_GET['innersubpage']."&id=".$Caste['id']."&pageno=".$_GET['pageno']."&action=Edit' class='action-button' title='user-edit'><span class='user-edit'></span></a>  &nbsp; <a href='#' onclick='deleterow(".$Caste['id'].")' class='action-button' title='user-delete'><span class='user-delete'></span></a></td>
						</tr>";
					} ?>
				</tbody>
			</table>
...
<script>
	...
	function validation()
	{
		...
		if(document.getElementById("classname").value.length < 2 || document.getElementById("classname").value.length > 15)
			message = "Caste name should be within 2 to 15 characters";	
		if(document.getElementById("classname").value == " ")
			message = "Please enter Caste name";
		if(message)
		{
			alert(message);
			return false;
