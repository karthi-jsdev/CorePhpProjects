	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			<h3>Subject List
				...
				echo " : No. of Total Subject - ".$SubjectTotalRows['total'];
				?>
			</h3>
			<hr />			
				...
				<tbody>
					...
					while($Subject = mysqli_fetch_assoc($SubjectRows))
					{
						echo "<tr style='valign:middle;'>
							...
							<td>".$Subject['name']."</td>
							<td ><a href='index.php?page=".$_GET['page']."&subpage=".$_GET['subpage']."&innersubpage=".$_GET['innersubpage']."&id=".$Subject['id']."&pageno=".$_GET['pageno']."&action=Edit' class='action-button' title='user-edit'><span class='user-edit'></span></a>  &nbsp; <a href='#' onclick='deleterow(".$Subject['id'].")' class='action-button' title='user-delete'><span class='user-delete'></span></a></td>
						</tr>";
					} ?>
				</tbody>
			</table>
