			...
			<fieldset>
				<div class="clearfix">
					...
					<label>Days After Due Date <font color="red">*</font>
						<input type="text" name="days" id="days" required="required" value="<?php echo $_POST['days']; ?>"  onkeypress="return isNumeric(event)">
					</label>
				</div>	
				<div class="clearfix">
					<label>Fine Amount <font color="red">*</font>
						<input type="text" name="amount" id="amount" required="required" value="<?php echo $_POST['amount']; ?>"  onkeypress="return isNumeric(event)">
					</label>
				</div>
			</fieldset>
			<hr />
	...
	function validation()
	{
		...
		if(mode_val == 0)
		{
			if(document.getElementById("amount").value > 100)
				message = "Fine amount is not more than 100%";
		}
