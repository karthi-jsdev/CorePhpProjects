<?php
	function Staff_Insert()
	{
		...
		mysqli_query($_SESSION['connection'],"Insert into staff_admission(id,joined_date,name_prefix,first_name,last_name,dob,gender,phone_no,email_id,
		...
		$FetchLastId = mysqli_fetch_array(mysqli_query($_SESSION['connection'],"select * from staff_admission order by id desc"));
		$Query = "";$Count = 0;
		if($_POST['partculars'])
		{
		...
		return mysqli_query($_SESSION['connection'],"insert into salary_assignment(id,employee_id,department_id,grade_id,basic_pay,da,hra,cca,ma,lop,datetime) values('','".$FetchLastId['id']."','".$_POST['department']."','".$_POST['grade']."',$Query,'".date('Y-m-d h:i:s')."')");
	}
	function Staff_Update()
	{
		...
		mysqli_query($_SESSION['connection'],"UPDATE staff_admission SET joined_date='".date('Y-m-d',strtotime($_POST['date']))."',name_prefix='".$_POST['nameprefix']."',first_name='".$_POST['name']."',last_name='".$_POST['lastname']."',dob='".date('Y-m-d',strtotime($_POST['dob']))."',gender='".$_POST['gender']."',phone_no='".$_POST['contactnumber']."',email_id='".$_POST['email']."',
		...
		return mysqli_query($_SESSION['connection'],"UPDATE salary_assignment SET department_id='".$_POST['department']."',grade_id='".$_POST['grade']."',$Query,datetime='".date('Y-m-d h:i:s')."' where employee_id='".$_POST['id']."'");
	}	
	...
	{
		return mysqli_query($_SESSION['connection'],"Select * From qualification");
	}
	...
	{
		return mysqli_query($_SESSION['connection'],"Select * From subject");
	}
	function Fetch_LastEmployeeNum()
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_admission order by id desc");
	}
	function Select_Name()
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_admission order by first_name asc");
	}
	function Employee_Select_ById()
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_admission where id='".$_GET['id']."'");
	}
	function Staff_Details_Insert()
	{
		if(!$_POST['cteacher'])
			$_POST['cteacher'] = 0;
		return mysqli_query($_SESSION['connection'],"INSERT INTO staff_details values('','".$_POST['name']."','".$_POST['employeenum']."','".$_POST['section']."','".implode($_POST['subjects'], ",")."','".$_POST['cteacher']."')");
	}
	function Select_Staff_Details()
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_details Order By id desc");
	}
	function StaffDetails_Select_ById()
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_details where id='".$_GET['id']."'");
	}
	function Staff_Details_Update()
	{
		if(!$_POST['cteacher'])
			$_POST['cteacher'] = 0;
		return mysqli_query($_SESSION['connection'],"Update staff_details Set name='".$_POST['name']."',emp_no='".$_POST['employeenum']."',section_id='".$_POST['section']."',subject_ids='".implode($_POST['subjects'], ",")."',is_class_teacher='".$_POST['cteacher']."' Where id='".$_POST['id']."'");
	}
	function Select_Grade()
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_grade");
	}
	function Salary_Details($Grade,$Department)
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_salary_assignment Where department_id='".$Department."' and grade_id='".$Grade."'");
	}
	function Select_SalaryDetails($Id)
	{
		return mysqli_query($_SESSION['connection'],"Select * From salary_assignment where employee_id='".$Id."'");
	}
	function FetchEmployeeId($Id)
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_admission where id='".$Id."'");
	}
	...
	{
		return mysqli_query($_SESSION['connection'],"Select * From staff_grade where id='".$Id."'");
	}
	function FetchDesignationById($Id)
	{
		return mysqli_query($_SESSION['connection'],"Select * From designation where id='".$Id."'");
	}
