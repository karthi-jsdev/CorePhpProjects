	...
	<div class="columns" style='width:902px;'>
		...
		<div class="columns">
			<h3>Category List
				...
				echo " : No. of Total Category - ".$CategoryTotalRows['total'];
				?>
			</h3>
			<hr />			
...
<script>
	...
	{
		var message = "";
		if(document.getElementById("categoryname").value.length < 2 || document.getElementById("categoryname").value.length > 15)
			message = "Category name should be within 2 to 15 characters";
